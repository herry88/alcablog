      ...
      <div class="modal-body">
        <form action="/berita/add" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Berita</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/berita/update" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="recipient-name" class="col-form-label">Nama Berita</label>
...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header-index" style="display: flex; justify-content: space-between; align-items: center;">
      <h6 class="m-0 font-weight-bold"><strong>Data Berita</strong></h6>
